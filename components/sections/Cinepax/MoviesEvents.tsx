...
const movieData: Record<TabType, MovieCardData[]> = {
  "Now Showing": [
    { image: "/Movies/avatar.jpeg", title: "Avatar", details: "Action • Adventure • Sci-Fi • 3h 17m", buttonText: "Book Now" },
    { image: "/Movies/anacona_1.jpg", title: "Anaconda", details: "Action • Comedy • Horror • 1h 39m", buttonText: "Book Now" },
    { image: "/Movies/marty supreme_1.jpg", title: "Marty Supreme", details: "Drama • Sport • 2h 30m", buttonText: "Book Now" },
    { image: "/Movies/gladiator II.jpg", title: "Gladiator II", details: "Action • Drama • Epic • 2h 45m", buttonText: "Book Now" },
  ],
  "Coming Soon": [
    { image: "/Movies/greenland2_1.jpg", title: "Greenland 2: Migration", details: "Action • Thriller • January 9, 2026", buttonText: "Get Notified" },
    { image: "/Movies/the bone temple_1.jpg", title: "28 Years Later: The Bone Temple", details: "Horror • January 16, 2026", buttonText: "Get Notified" },
    { image: "/Movies/primate_1.jpg", title: "Primate", details: "Horror • Sci-Fi • January 2026", buttonText: "Get Notified" },
    { image: "/Movies/avatar 3.jpg", title: "Avatar 3", details: "Action • Adventure • Sci-Fi • December 2026", buttonText: "Get Notified" },
  ],
};
