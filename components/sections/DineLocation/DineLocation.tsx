...
interface DineLocationProps {
  dine: DineDetail;
}

const DineLocation = ({ dine }: DineLocationProps) => {
  const handleShare = (platform: 'twitter' | 'facebook') => {
    const url = typeof window !== 'undefined' ? window.location.href : '';
    const text = `Check out ${dine.name} at Giga Mall!`;
  ...
  const mapPosition = dine.location?.mapPosition || { x: 50, y: 50 };
      ...
      >
        ...
        >
          ...
          >
            ...
            {/* Sample Restaurant Labels (for visual context) */}
            <Box
              sx={{
                position: 'absolute',
                top: '20%',
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                Location: {dine.name} / Level: {locationInfo.level} / Parking: {locationInfo.parking}
              </Typography>
            </Box>
          </Box>
