...
const StorePageContent = ({ store }: StorePageContentProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Store Location Section - Map and Brand Details */}
      <Box
        sx={{
          width: '100%',
          backgroundColor: '#ffffff',
      ...
      >
        ...
        >
          ...
          >
            {/* <MallMapStandalone /> */}
            <MallMapStandalone key={`shop-${store.slug}`} highlightedShop={store.slug} />
          </Box>
          ...
          >
            ...
            {/* Contact Information */}
            {store.contact && (store.contact.phone || store.contact.email) && (
              <Box
                sx={{
                  display: 'flex',
                  flexDirection: 'column',
