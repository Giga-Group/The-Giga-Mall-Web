...
export const getMobileBrandImage = (originalImage: string, brandName?: string, brandSlug?: string): string => {
  ...
  const mobileImageMap: Record<string, string> = {
    ...
    'baskin-robin': '/shops/baskin robin mobile.JPG',
    ...
    // 'zero': '',
    'ashraf-naturals': '/shops/ashraf naturals mobile.JPG',
    'asian-fusion': '/shops/asian fusion mobile.JPG',
    ...
    'potato-factory': '/shops/potato factory mobile.JPG',
